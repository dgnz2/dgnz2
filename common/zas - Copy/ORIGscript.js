...
if (siteSection == "item") {
	...
	$('.container').prepend(
		// LOGO
		' <img style="display:block; margin:10px auto; width:125px" src="../../../common/zedign_logo.jpg" /> ' +
		//////// BREADCRUMBS
		'<ol class="breadcrumb" style="text-transform: capitalize"> <li><a href="/zas/">Home</a></li> <li class="active"><a href="../">' + catname + '</a></li>  <li><a href="./">' + dirname.replace(/\-/ig, " ") + '</a></li> </ol>' +
		// 
		'');
	// ITEM BODY
	$('.container').append(
